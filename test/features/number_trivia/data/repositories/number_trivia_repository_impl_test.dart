...
import 'package:clean_tdd/features/number_trivia/data/datasources/number_trivia_remote_data_source.dart';
...
void main() {
  NumberTriviaRespoitoryImpl repository;
  ...
  setUp(() {
    ...
    mockLocalDataSource = MockLocalDataSource();
    mockNetworkInfo = MockNetworkInfo();
    repository = NumberTriviaRespoitoryImpl(
  ...
  group('getConcreteNumberTrivia', () {
    ...
    test(
      'should check if the device in online',
      () async {
        // arrrange
        when(mockNetworkInfo.isConnected).thenAnswer((_) async => true);
        // act
